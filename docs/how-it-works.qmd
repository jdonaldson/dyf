...
flowchart TD
    ...
    style dense fill:#e6ffe6,stroke:#2d8a2d
    style bridge fill:#fff4e6,stroke:#c47f17
    style orphan fill:#ffe6e6,stroke:#c44a4a
```
...
graph TD
    ...
    style R fill:#f0f4ff,stroke:#4a6fa5
    style A fill:#e6ffe6,stroke:#2d8a2d
    style B fill:#e6ffe6,stroke:#2d8a2d
    style D fill:#e6ffe6,stroke:#2d8a2d
    style A1 fill:#fff4e6,stroke:#c47f17
    style A2 fill:#fff4e6,stroke:#c47f17
```
...
%%| fig-width: 8
flowchart LR
    Q["Query\nembedding"] --> H["Hash through\ntree"]
    H --> L["Find matching\nleaf bucket"]
    L --> S["Score embeddings\nin leaf"]
    S --> R["Return\ntop-k"]

    H -.->|"near boundary?"| P["Probe\nadditional leaves"]
    P --> S

    style Q fill:#f0f4ff,stroke:#4a6fa5
    style R fill:#e6ffe6,stroke:#2d8a2d
    style P fill:#fff4e6,stroke:#c47f17
```
