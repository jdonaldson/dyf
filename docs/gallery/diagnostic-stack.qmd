...
- **What survives:** (a) detection of pre-known specific topology like the annulus example below — ripser does what it mathematically should; (b) cycle vertex content with ≥2 distinct cell types traces lineage relationships (Marrow myeloid lineage, Spleen erythroblastic islands); (c) pooling cycling cells across cell types reveals a real cell-cycle ring topology with persistence ~3.
