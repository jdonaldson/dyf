...
| neighbors    | [Optional](`typing.Optional`)\[[np](`numpy`).[ndarray](`numpy.ndarray`)\] | Pre-computed k-NN indices (n, k+1). If None, computed internally. | `None`     |
| similarities | [Optional](`typing.Optional`)\[[np](`numpy`).[ndarray](`numpy.ndarray`)\] | Pre-computed similarities (n, k+1). If None, computed internally. | `None`     |
